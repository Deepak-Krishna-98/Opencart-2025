...
public class TC_006_EndToEndTest extends BaseClass {
	...
	regpage.setConformPassword("test123");
	...
	System.out.println("Going to My Account Page? "+ mc.IsMyAccPageExists());
	myassert.assertEquals(mc.IsMyAccPageExists(), true); //validation
